...
actor ReceiptManager {
  ...
  private let shouldBypassAppTransactions: Bool
  ...
  private func setAppTransactionId() async {
    #if compiler(>=6.1)
    if #available(iOS 16.0, *), !shouldBypassAppTransactions {
